...
- The first product is [Breadcrum](https://breadcrum.net/), a bookmarking service with textual and media archiving super powers.
...
- I'm now working at [Socket Supply](https://github.com/socketsupply/socket) on a runtime and P2P full time again. Really happy to be back in this space again.
...
- Now that Twitter (*ahem* X) has completely abandoned its charter as an open web website, you can find me posting on [@bcomnes@fosstodon.org](https://fosstodon.org/@bcomnes) and [@bret.io on Bluesky](https://bsky.app/profile/bret.io). I would like to make this website authoritative for my posts, though.
